...
//        skEyeSDK.SKEyeSDKColorCast(1, (float)0.9, 1);
        objectsRes = new int[]{R.drawable.banana,R.drawable.fruit4,R.drawable.fruit5,
                R.drawable.watermelon, R.drawable.pear, R.drawable.strawberry,
                R.drawable.grape,R.drawable.fruit1,R.drawable.fruit2,R.drawable.fruit3,
                R.drawable.mango,R.drawable.orange,R.drawable.pineapple
        };
        fruitsRes = new int[]{R.drawable.object1, R.drawable.object2,
